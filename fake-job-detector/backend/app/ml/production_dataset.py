...
_EXPANDED_PRODUCTION_CORPUS: List[Dict[str, Any]] = [
    ...
    # ------------------ LEGITIMATE: INDIAN ENTERPRISE & TECH HUBS ------------------
    {"id": "LEGIT-IN-001", "title": "Senior React / Node Developer", "company": "Tata Consultancy Services (TCS)", "text": "TCS is hiring a Senior Full Stack Engineer in Bangalore/Hyderabad. 4-7 years experience in React, Node.js, AWS, and TypeScript. Compensation: 12 - 18 LPA CTC with annual performance bonus, health insurance, and provident fund. Standard 3-stage technical interview and background verification. Apply via https://ibegin.tcs.com/iBegin/.", "label": 0, "category": "indian_tech_enterprise", "source": "Naukri Verified Corporate Listing", "ref": "https://ibegin.tcs.com", "license": "UNKNOWN / Public Corporate Posting"},
    {"id": "LEGIT-IN-002", "title": "Lead Java Backend Engineer", "company": "Infosys Limited", "text": "Infosys is looking for a Lead Java Developer in Pune. Requirements: 5+ years Java 17, Spring Boot, Microservices, Kafka, and Kubernetes. Salary 15 - 22 LPA depending on experience. Selection involves coding challenge, architecture discussion, and HR interview. Official applications only at https://careers.infosys.com.", "label": 0, "category": "indian_tech_enterprise", "source": "Infosys Careers Portal", "ref": "https://careers.infosys.com", "license": "UNKNOWN / Public Corporate Posting"},
    {"id": "LEGIT-IN-003", "title": "Data Platform Engineer", "company": "Swiggy", "text": "Swiggy is seeking a Data Engineer in Bangalore. Build high-throughput data ingestion pipelines processing millions of orders daily. PySpark, Airflow, Snowflake, and BigQuery. CTC 24 - 36 LPA plus ESOPs. Apply directly on https://careers.swiggy.com.", "label": 0, "category": "indian_tech_enterprise", "source": "Swiggy Careers Portal", "ref": "https://careers.swiggy.com", "license": "UNKNOWN / Public Corporate Posting"},
    {"id": "LEGIT-IN-004", "title": "Customer Support Executive (Voice)", "company": "Teleperformance India", "text": "Teleperformance is hiring Customer Care Associates in Jaipur and Gurgaon. Handle inbound customer inquiries and resolution. Salary: Rs. 22,000 - Rs. 28,000 per month with night shift allowances and PF. Apply at https://teleperformance.com/en-us/careers.", "label": 0, "category": "customer_support", "source": "Naukri Portal", "ref": "https://teleperformance.com", "license": "UNKNOWN / Public Corporate Posting"},

    # ------------------ FRAUD: INDIAN CYBERCRIME & TASK SCAMS (I4C / 1930 HELPLINE) ------------------
    {"id": "FRAUD-IN-001", "title": "YouTube Video Liking & Telegram VIP Recharge", "company": "Global Task Media", "text": "Earn Rs. 150 per video like, Rs. 3,000 - Rs. 5,000 daily from home! Like 3 YouTube videos and send screenshots to WhatsApp HR. Join Telegram channel to recharge VIP task wallet and withdraw commission via UPI (GPay/PhonePe).", "label": 1, "category": "indian_task_scam", "source": "I4C 1930 Cybercrime Helpline", "ref": "MHA Task Fraud Advisory", "license": "UNKNOWN / Threat Feed"},
    {"id": "FRAUD-IN-002", "title": "Work from Home Typing - Registration Fee Trap", "company": "National Data Entry Solutions", "text": "Part time typing work from home. Earn Rs. 50 per page, up to Rs. 4,000 daily. Direct selection without interview. Pay mandatory refundable software license and security deposit of Rs. 1,999 to UPI ID hrdesk@okaxis before work allocation.", "label": 1, "category": "advance_fee", "source": "Cybercrime.gov.in Advisory", "ref": "Data Entry Software Fee Fraud", "license": "UNKNOWN / Threat Feed"},
    {"id": "FRAUD-IN-003", "title": "Fake TCS Appointment Letter - Gatepass Security Deposit", "company": "Tata Consultancy Services (Impersonation)", "text": "Congratulations! You are shortlisted for TCS System Engineer (6.5 LPA) without exam. Pay refundable laptop gatepass and training registration fee of Rs. 4,500 via UPI QR code attached. Report to TCS campus after payment.", "label": 1, "category": "impersonation", "source": "TCS Security Advisory & Police Cyber Cell", "ref": "Fake IT Appointment Letter Scam", "license": "UNKNOWN / Threat Feed"},
    {"id": "FRAUD-IN-004", "title": "Google Maps 5-Star Rating Task Scheme", "company": "Digital Media Review Agency", "text": "Work 1 hour daily writing 5-star Google Maps reviews for hotels and restaurants. Earn Rs. 200 per review. Deposit Rs. 2,000 into prepaid wallet to unlock level 2 high payout task package. Payouts via Paytm/PhonePe.", "label": 1, "category": "indian_task_scam", "source": "I4C Cybercrime Advisory", "ref": "Google Map Rating Task Scam", "license": "UNKNOWN / Threat Feed"},
    {"id": "FRAUD-IN-005", "title": "Aadhaar Card OTP Verification & KYC Harvesting", "company": "Govt Digital Data Verification Desk", "text": "Government data entry project. Salary Rs. 35,000 per month. Selected candidates must upload Aadhaar card copy and send 6-digit Aadhaar UIDAI OTP to recruiter on WhatsApp to verify identity and activate bank payroll.", "label": 1, "category": "pii_phishing", "source": "RBI / Cybercrime India Advisory", "ref": "Aadhaar OTP Job Fraud", "license": "UNKNOWN / Threat Feed"},
    {"id": "FRAUD-IN-006", "title": "Airport Ground Staff - Uniform & Security Badge Fee", "company": "Aviation Cargo Placement Services", "text": "Direct recruitment for Airport Ground Staff / Cargo Assistant in Delhi/Mumbai Airport. Salary Rs. 42,000/month. No exam. Send Rs. 3,500 for uniform and airport security pass to Google Pay UPI ID airportcareers@oksbi.", "label": 1, "category": "advance_fee", "source": "Airport Authority of India Advisory", "ref": "Aviation Ground Staff Fee Scam", "license": "UNKNOWN / Threat Feed"},
]
