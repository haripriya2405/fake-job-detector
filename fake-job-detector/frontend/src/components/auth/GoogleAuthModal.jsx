  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-fadeIn">
      ...
      {step === 'choose_account' ? (
        ...
        /* Image 2: Light Theme "Sign in - Email or phone" Modal */
        <div className="relative w-full max-w-2xl bg-[#f0f4f9] text-slate-900 rounded-3xl shadow-2xl overflow-hidden font-sans">
          ...
          {onClose && (
            <button
              type="button"
              onClick={onClose}
              className="absolute top-4 right-4 text-slate-500 hover:text-slate-900 transition-colors p-1.5 rounded-full hover:bg-slate-200 z-10"
              aria-label="Close"
            >
              <X className="w-5 h-5" />
            </button>
          ...
          {/* Main White Card matching Image 2 */}
          <div className="m-3 sm:m-4 bg-white rounded-2xl shadow-sm p-8 sm:p-10">
            ...
            {/* Grid Layout: Left Title & Right Email Input Form */}
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
              ...
              {/* Right Column: Floating Input Field & Action Buttons matching Image 2 */}
              <div className="md:col-span-7 space-y-5">
                
                <form onSubmit={handleNextSubmit} className="space-y-4">
                  {/* Floating label outline input matching Image 2 */}
                  <div className="relative border-2 border-blue-600 rounded-lg bg-white px-3.5 py-2.5 focus-within:ring-2 focus-within:ring-blue-600 transition-all">
                    ...
                    <input
                      ...
                      className="w-full text-base text-slate-900 bg-transparent outline-none pt-1"
                    />
                  </div>
                  ...
                  {/* Terms disclaimer matching Image 2 */}
                  ...
                  {/* Action Buttons matching Image 2: Create account on left, Next on right */}
                  <div className="flex items-center justify-between pt-6">
                    ...
                    <button
                      type="submit"
                      disabled={isLoading}
                      className="px-6 py-2.5 rounded-full bg-[#0b57d0] hover:bg-blue-700 active:bg-blue-800 text-white text-xs font-medium transition-all shadow-sm disabled:opacity-50"
                    >
          ...
          {/* Outer Footer Bar matching Image 2 */}
          <div className="px-8 py-3.5 flex items-center justify-between text-xs text-slate-600 font-normal">
            <button type="button" className="flex items-center gap-1 hover:text-slate-900">
              <span>English (United States)</span>
              <ChevronDown className="w-3.5 h-3.5" />
            </button>
            <div className="flex items-center gap-6">
              <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-slate-900">Help</a>
              <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-slate-900">Privacy</a>
              <a href="#" onClick={(e) => e.preventDefault()} className="hover:text-slate-900">Terms</a>
            </div>
          </div>
